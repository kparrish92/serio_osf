...
create_pairwise_table("Both_Artifact_Both_Natural", "Both_Artifact_Both_Value", "Both_Natural_Both_Value") %>% 
  write.csv(here("data", "tidy", "exp4_posthoc_table_both_default.csv"))

ggsave("both_cond_plots_default.png", path = here("report", "exp4", "figs"))
...
create_pairwise_table("Is_Artifact_Is_Natural", "Is_Artifact_Is_Value", "Is_Natural_Is_Value") %>% 
  write.csv(here("data", "tidy", "exp4_posthoc_table_is_default.csv"))

ggsave("is_cond_plots_default.png", path = here("report", "exp4", "figs"))
...
create_pairwise_table_d("Is not_Artifact_Is not_Natural", "Is not_Artifact_Is not_Value", 
                      "Is not_Natural_Is not_Value") %>% 
  write.csv(here("data", "tidy", "exp4_posthoc_table_isnot_default.csv"))

ggsave("isnot_cond_plots_default.png", path = here("report", "exp4", "figs"))
...
all_data_s %>% 
  ...
  select(Comparison, Effect, Compelling_difference) %>% 
  arrange(desc(Comparison)) %>% 
  write.csv(here("data", "tidy", "exp4_posthoc_table_natural_default.csv"))

ggsave("within_nk_default.png", path = here("report", "exp4", "figs"))
...
create_pairwise_table("Is_Artifact_Both_Artifact", "Is_Artifact_Is not_Artifact", 
                      "Both_Artifact_Is not_Artifact") %>% 
  write.csv(here("data", "tidy", "exp4_posthoc_table_artifact_default.csv"))

ggsave("within_art_default.png", path = here("report", "exp4", "figs"))
...
create_pairwise_table("Is_Value_Both_Value", "Is_Value_Is not_Value", 
                      "Both_Value_Is not_Value") %>% 
  write.csv(here("data", "tidy", "exp4_posthoc_table_value_default.csv"))

ggsave("within_value_default.png", path = here("report", "exp4", "figs"))
