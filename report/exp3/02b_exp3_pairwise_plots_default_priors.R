...
exp3_pw = read.csv(here("data", "tidy", "exp3_pairwise_data_s.csv"))
...
create_pairwise_table("Elaine right_artifact_Elaine right_natural_kind", 
  ...
  write.csv(here("data", "tidy", "exp3_posthoc_table_elaine_default.csv"))

ggsave("elaine_pairw_default.png", path = here("report", "exp3", "figs"))
...
create_pairwise_table("Akira right_artifact_Akira right_natural_kind", 
  ...
  write.csv(here("data", "tidy", "exp3_posthoc_table_akira_default.csv"))

ggsave("akira_pairw_default.png", path = here("report", "exp3", "figs"))
...
create_pairwise_table("Both_artifact_Both_natural_kind", 
  ...
  write.csv(here("data", "tidy", "exp3_posthoc_table_both_default.csv"))

ggsave("both_pairw_default.png", path = here("report", "exp3", "figs"))
...
create_pairwise_table("Both_value_Elaine right_value", 
  ...
  write.csv(here("data", "tidy", "exp3_posthoc_table_value_default.csv"))

ggsave("value_pairw_default.png", path = here("report", "exp3", "figs"))
...
create_pairwise_table("Both_natural_kind_Elaine right_natural_kind", 
  ...
  write.csv(here("data", "tidy", "exp3_posthoc_table_nk_default.csv"))

ggsave("nk_pairw_default.png", path = here("report", "exp3", "figs"))
...
create_pairwise_table("Both_artifact_Elaine right_artifact", 
  ...
  write.csv(here("data", "tidy", "exp3_posthoc_table_art_default.csv"))

ggsave("art_pairw_default.png", path = here("report", "exp3", "figs"))
